...
#ifndef ROCKETMQ_ONCE_CLIENT_PHP_ORDER_MESSAGE_LISTENER_H
#define ROCKETMQ_ONCE_CLIENT_PHP_ORDER_MESSAGE_LISTENER_H

#include "common.h"

using namespace ons;

class MQOrderMessageListener : public MessageOrderListener, public Php::Base {
private:
    Php::Value callback;
public:
...
#endif //ROCKETMQ_ONCE_CLIENT_PHP_ORDER_MESSAGE_LISTENER_H
